...
| ----------------------------------------------------------- | ------------ | ------ | ------ | ------------------------------------------------------------------------------------------------------------------------------------------------- |
| Fix skip-directive scoping bug                              | 🔴 `TODO`    | High   | 30min  | `pkg/extractor.go:104` checks directives on every line, including code content — a block containing `//nolint` silently skips the NEXT block. Latent bug flagged 2026-06-05, still present. |
